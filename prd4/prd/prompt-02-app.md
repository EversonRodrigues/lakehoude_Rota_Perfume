...
Rodado contra `lakehouse_rotaperfume` no workspace `rotaperfumes`, profile
`rotaperfumes`, warehouse `47307f0445a667ac`.
...
> outro workspace e traz profile `projeto-dados-ia`, warehouse
> `666be37e3fededf2`, 35 vendedores, R$ 582.799,50, lift 4,25 e 86 acertos.
...
```bash
databricks warehouses start 47307f0445a667ac --profile rotaperfumes
```
...
1. O SCAFFOLD
   ...
   databricks apps init --name rotaperfume-direcao \
     ...
     --set analytics.sql-warehouse.id=47307f0445a667ac \
...
```bash
databricks apps get rotaperfume-direcao --profile rotaperfumes -o json | \
