...
`rotaperfumes`, warehouse `47307f0445a667ac`. **Tudo o que este prompt lê já
existe:**
...
```bash
databricks genie list-spaces --profile rotaperfumes
# tem que listar os DOIS: "Rota Perfume - Comercial" e "Rota Perfume · Direção"

databricks bundle summary --target dev --profile rotaperfumes
...
```powershell
.\scripts\rodar-tarefa.ps1 rotaperfumes auditoria_de_metadado   # FAILED
```
